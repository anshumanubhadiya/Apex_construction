    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-slate-900 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl font-bold text-white mb-4">About Apex Construction</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-20">
          <div>
            ...
            <p className="text-slate-600 leading-relaxed mb-4">
              Founded over 25 years ago, Apex Construction began with a single pickup truck and a commitment to quality craftsmanship. Today, we are one of the region's most respected construction firms, known for our integrity, precision, and ability to handle complex projects.
            </p>
        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                    { name: 'Robert Fox', role: 'CEO & Founder', img: 'https://picsum.photos/300/300?random=30' },
                    { name: 'Sarah Connor', role: 'Lead Architect', img: 'https://picsum.photos/300/300?random=31' },
                    { name: 'Michael Chen', role: 'Project Manager', img: 'https://picsum.photos/300/300?random=32' },
                ].map((member, i) => (
