        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
          <div className="max-w-2xl">
            ...
            <p className="text-lg text-slate-300 mb-8 max-w-xl">
              From concept to creation, Apex Construction delivers superior quality residential and commercial projects. Experience the difference of master craftsmanship.
            </p>
      ...
      <div className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-slate-900 sm:text-4xl">Why Choose Apex?</h2>
