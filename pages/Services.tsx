      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-20 bg-amber-500 rounded-2xl p-8 md:p-12 shadow-lg">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-6">"Apex Construction transformed our vision into reality. Their attention to detail during our office renovation was unparalleled."</h2>
            <div className="flex items-center justify-center space-x-4">
              <div className="w-12 h-12 bg-slate-900 rounded-full flex items-center justify-center text-white font-bold">JS</div>
