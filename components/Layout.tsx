        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <Link to="/" className="flex items-center space-x-2 group">
              ...
              <span className="text-xl font-bold tracking-wider">APEX<span className="text-amber-500">CONST</span></span>
            </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-lg font-bold text-white tracking-wider">APEX<span className="text-amber-500">CONST</span></span>
              </div>
              <p className="text-sm leading-relaxed">
                Building dreams with precision and integrity since 1995. We specialize in residential, commercial, and industrial construction projects.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li className="flex items-start space-x-3">
                  ...
                  <span>123 Construction Blvd,<br />Builder City, ST 90210</span>
                </li>
